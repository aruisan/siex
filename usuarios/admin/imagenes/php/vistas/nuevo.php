        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="container">
			<div class="row">
				<h3 style="text-align:center">NUEVO DOCUMENTO</h3>
			</div>
			<div class="col-md-10">
			<form class="form-horizontal" method="POST" action="../crud/guardar.php" enctype="multipart/form-data" autocomplete="off">
