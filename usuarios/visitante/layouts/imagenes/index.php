            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="" id="procesos"><i class="fa fa-indent fa-fw"></i> Mis Procesos </a>
                        </li>
                        <li>
                            <a href="" id="usuarios"><i class="fa  fa-users fa-fw"></i> Editar Perfil </a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="container">
						<center><h3>Proceso (<?= $result->nom_tipo_proceso; ?>) : <?= $result->num_proceso; ?></h3></center>
